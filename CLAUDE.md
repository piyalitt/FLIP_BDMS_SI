...
- **SSH-over-SSM for AWS EC2 access** (mandatory):
  ...
  - See [Deployment Guide](deploy/providers/AWS/README.md#remote-access-via-ssm-session-manager) and [Migration Guide](deploy/providers/AWS/MIGRATION_SSH_TO_SSM.md)
