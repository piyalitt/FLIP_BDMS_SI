...
resource "aws_cognito_user_pool" "flip_user_pool" {
  ...
  # Templates are stored in email_templates/ directory and loaded by both Terraform and Python testing script
  ...
  # Cognito email templates for password reset and account verification flows
    ...
    email_message         = file("${path.module}/email_templates/password_reset_code.html")
    ...
    email_message_by_link = file("${path.module}/email_templates/password_reset_link.html")
