...
class EmailTemplateTester:
    """Tests and renders FLIP Cognito email templates."""

    # Template constants - matching services.tf configuration
    INVITE_TEMPLATE_HTML = """<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Inter, 'Helvetica Neue', sans-serif; background-color: #f5f5f5;">
  <table cellpadding="0" cellspacing="0" width="100%" style="background-color: #f5f5f5;">
              ...
              <table cellpadding="0" cellspacing="0" style="margin: 24px 0;">
                <tr>
                  <td style="background-color: #61366e; border-radius: 6px; text-align: center; padding: 0;">
                    <a href="https://{flip_alb_subdomain}" style="display: inline-block; padding: 12px 32px; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 16px;">Sign In to FLIP</a>
                  </td>
                </tr>
              </table>
    ...
    PASSWORD_RESET_CODE_TEMPLATE_HTML = """<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Inter, 'Helvetica Neue', sans-serif; background-color: #f5f5f5;">
  <table cellpadding="0" cellspacing="0" width="100%" style="background-color: #f5f5f5;">
    ...
    PASSWORD_RESET_LINK_TEMPLATE_HTML = """<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Inter, 'Helvetica Neue', sans-serif; background-color: #f5f5f5;">
  <table cellpadding="0" cellspacing="0" width="100%" style="background-color: #f5f5f5;">
    ...
    def __init__(self, test_user: Optional[TestUser] = None):
        """Initialize the tester with test user data."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Test FLIP Cognito email templates locally"
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
    ...
    parser.add_argument(
        "--serve",
        action="store_true",
        help="Start local HTTP server to view previews (default port: 8000)"
    )
    parser.add_argument(
        "--port",
        type=int,
    ...
    if args.serve:
        ...
        print(f"Open the following URLs in your browser:")
